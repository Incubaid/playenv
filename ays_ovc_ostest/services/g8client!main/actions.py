...
class actionmethod(ActionMethodDecorator):
    def __init__(self,*args,**kwargs):
        ...
        self.selfobjCode="service=j.atyourservice.getService(role='g8client', instance='main', die=True);selfobj=service.actions;selfobj.service=service"
class Actions():
    def getClient(self):
        """
        return client towards g8 master
        """
        return j.clients.openvcloud.get("du-conv-3.demo.greenitglobe.com", 'despiegk', 'kds007kds')
